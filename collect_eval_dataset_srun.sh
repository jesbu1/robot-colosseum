...
do
    srun -A nvr_srl_simpler --gres gpu:$ngpus \
                ...
                --container-mounts $HOME/robot-colosseum/collect_eval_dataset.sh:/home/jeszhang/robot-colosseum/collect_eval_dataset.sh,/home/jeszhang/data/:/home/jeszhang/data/,/usr/bin/nvidia-xconfig:/usr/bin/nvidia-xconfig,/home/jeszhang/3d_diffuser_actor/RLBench:/home/jeszhang/3d_diffuser_actor/RLBench \
